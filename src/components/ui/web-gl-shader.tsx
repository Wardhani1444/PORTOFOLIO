...
export function WebGLShader({
  ...
  // Keep speed in a ref to avoid re-triggering the main effect on every speed change
  const speedRef = useRef(speed)
  useEffect(() => {
    speedRef.current = speed
  }, [speed])

  // Synchronize uniforms when scale or distortion props change
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      if (refs.uniforms) {
        refs.uniforms.time.value += speedRef.current
      }
